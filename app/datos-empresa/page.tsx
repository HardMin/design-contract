...
export default function DatosEmpresaPage() {
  ...
  rut: "76321987",
  dv: "K",
  razonSocial: "Estudios Creativos SpA",
  direccion: "Av. Providencia 1000, Oficina 505",
  comuna: "PROVIDENCIA",
  ciudad: "Santiago",
  representanteRut: "11223344",
  representanteDv: "5",
  representanteNombre: "Javier Ignacio",
  representanteApellidoPaterno: "Figueroa",
  representanteApellidoMaterno: "Salinas",
  representanteDireccion: "Av. Providencia 1000, Oficina 505",
  ...
  idEmpresaFE: "20105",
  headerID: "512",
  headerMail: "contacto@estudioscreativos.cl",
  headerToken: "aB7cD8eF9gH0iJ1kL2",
  docContrato: "6001",
  docLiquidacion: "6002",
  })
